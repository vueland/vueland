...
| [Utils JIT](./utils-jit/getting-started)                     | `@vueland/utils-jit`           | Framework-agnostic Vite plugin that generates utility CSS on demand, including arbitrary values and custom `defineRule` utilities |
