...
| `c-app--block-scroll` | Служебное состояние блокировки прокрутки |
...
| ----------------------------- | -------------------- | ------------------------------------------------ |
| `--c-application-scroll-top`  | После `lockScroll()` | Отрицательная сохранённая позиция прокрутки по Y |
| `--c-application-scroll-left` | После `lockScroll()` | Отрицательная сохранённая позиция прокрутки по X |
