...
- [#103](https://github.com/vueland/vueland/pull/103) [`71fe692`](https://github.com/vueland/vueland/commit/71fe69268bcac34525706cf446ad28a71fa5f0e9) Thanks [@wiseadme](https://github.com/wiseadme)! - Добавлен универсальный API `attrs`/`defineAttr` для сканирования runtime-атрибутов.
