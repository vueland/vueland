...
|--------|-------|----------|
| [Utils JIT](./plugins/utils-jit/getting-started) | `@vueland/utils-jit` | Vite-плагин, генерирующий произвольные CSS-утилиты по требованию — в бандл попадают только те классы, которые реально используются |
